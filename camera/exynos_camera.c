...
int exynos_camera_capture(struct exynos_camera *exynos_camera)
{
	...
	switch (format) {
		case V4L2_PIX_FMT_INTERLEAVED:
			...
			rc = s5c73m3_interleaved_decode(pointer, buffer_length, exynos_camera->capture_yuv_buffer,
					&yuv_length, width, height, exynos_camera->capture_jpeg_buffer, &jpeg_length,
